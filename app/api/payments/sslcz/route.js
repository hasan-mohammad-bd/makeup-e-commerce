...
export async function POST(request) {
  ...
  const nextBaseUrl = headersList.get("origin");
  ...
  try {
    ...
    if (orderResponse?.status === false) {
      console.log(orderResponse, "order creation response in ssl");
    ...
    const sslPaymentData = {
      ...
      fail_url: `${nextBaseUrl}/api/payments/sslcz/fail`,
