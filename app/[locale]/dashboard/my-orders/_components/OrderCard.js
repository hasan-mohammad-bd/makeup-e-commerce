	...
	const getOrderStatus = (status) => {
		...
		switch (status) {
			case orderFilterKeys.pending:
				statusElement = (
					<span className="rounded-lg px-2 py-1 bg-yellow-500">
			...
			case orderFilterKeys.confirmed:
				statusElement = (
					<span className="rounded-lg px-2 py-1 bg-secondary-700">
			...
			case orderFilterKeys.inDeliver:
				statusElement = (
					<span className="rounded-lg px-2 py-1 bg-blue-500">
			...
			case orderFilterKeys.complete:
				statusElement = (
					<span className="rounded-lg px-2 py-1 bg-green-500">
