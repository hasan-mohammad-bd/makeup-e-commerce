                ...
                <div className="flex gap-5">
                    ...
                    <div className="w-1/2">
                        ...
                        <ul className="product-tab-links flex justify-between items-center border-b border-slate-200 py-5 mt-5">
                            <li>
                                <Link href={`#`} className="active">প্রডাক্টের বিবরণ</Link>
                            </li>
                            <li>
                        ...
                        <div className="product-tab-content py-8 border-b-4 border-slate-200">
                            <div className="description">
                                ...
                                <p className="text-slate-700 my-5">Insta360 Go 2 Tiny Mighty Action Camera 1440P 50fps স্পোর্টস ক্যামেরা IPX8 4M ওয়াটারপ্রুফ ফ্লোস্টেট স্ট্যাবিলাইজেশন হাইপারল্যাপ্স স্লো মোশন রি-মোট কন্ট্রোল অটো এডিটিং WI-FI প্রিভিউ সমর্থন করে<br/><br/>
                                    Insta360 GO 2 হল বিশ্বের সবচেয়ে ছোট অ্যাকশন ক্যামেরা৷ এটির ওজন আপনার পুরানো অ্যাকশনের তুলনায় প্রায় 6X হালকা। 1/2.3 ইঞ্চি ইমেজ সেন্সর সহ, 1440P 50fps মসৃণ এবং পরিষ্কার ভিডিও রেকর্ড করতে পারে; লেন্স গার্ড সহ 4 মিটার IPX8 ওয়াটারপ্রুফ সমর্থন করে【 মাউন্ট এনিহোয়ার】 GO 2 এত ছোট, এটি যেকোনো জায়গায় ফিট করে৷ গিটার? সহজ। বিড়াল? আচ্ছা...যতক্ষণ আপনার বিড়াল আসলে আপনার কথা শোনে। যেকোন জায়গায় মাউন্ট আপ করতে এবং আপনার জীবনের সেরা মুহূর্তগুলি ক্যাপচার করতে ইন-দ্য-বক্স আনুষাঙ্গিকগুলি ব্যবহার করুন৷ দিগন্ত লক পুরোপুরি দিগন্ত সমতল করতে পারে; স্লো মোশন ফাংশন সুপার স্মুথ 120fps-এ একটি গুরুত্বপূর্ণ মুহূর্তকে 4X স্লো-মোতে কমিয়ে দিতে পারে
                                </p>
                                <ol className="list-decimal ps-4">
                                    <li className="text-slate-700 mb-4">আরও বেশি জায়গায় GO 2 মাউন্ট করুন এবং অ্যাকশনের জন্য প্রস্তুত হন</li>
                                    <li className="text-slate-700 mb-4">1/4&#x201D; স্ক্রু মাউন্ট এবং 2-প্রং মাউন্ট আনুষাঙ্গিক সমর্থন করে</li>
                                    <li className="text-slate-700 mb-4">দুটি আঠালো বেস সহ যেকোনো পৃষ্ঠে GO 2 আটকে দিন।</li>
                                </ol>
                                <div className="feature">
                                    <h6 className="text-base[16px] font-semibold font-title text-slate-700 mb-3">মূল বৈশিষ্ট্য:</h6>
                                    <ul className="list-disc ps-4">
                                        <li className="text-slate-700 mb-4">ক্ষুদ্র এবং পরাক্রমশালী: থাম্ব-আকারের অ্যাকশন ক্যামেরা যার ওজন মাত্র 1 আউজ। চটকদার 1440p ভিডিও শুট করতে একটি শক্তিশালী 1/2.3” ইমেজ সেন্সর ব্যবহার করে। 13ft পর্যন্ত শ্রমসাধ্য এবং জলরোধী</li>
                                        <li className="text-slate-700 mb-4">যেকোনো জায়গায় মাউন্ট করুন: পরিধানযোগ্য ক্যামেরা ডিজাইন। মাউন্ট GO 2 এর ম্যাগনেটিক ইন-দ্য-বক্স আনুষাঙ্গিক সহ যেকোনো জায়গায় হ্যান্ডস-ফ্রি শুট করুন</li>
                                        <li className="text-slate-700 mb-4">ফ্লোস্টেট স্টেবিলাইজেশন: ইমেজ স্টেবিলাইজেশন এবং হরাইজন লেভেলিং অ্যালগরিদম আপনার ভিডিও স্থির রাখে আপনি যেখানেই GO 2 মাউন্ট করুন না কেন। অ্যাকশন স্পোর্ট প্রস্তুত</li>
                                        <li className="text-slate-700 mb-4">মাল্টি-ইউজ চার্জ কেস: একটি পকেট-আকারের কেস সহ আসে যা একটি চার্জার, রিমোট কন্ট্রোল এবং ট্রাইপড সবই এক। 150 মিনিট পর্যন্ত ব্যাটারির আয়ু বাড়ায়</li>
