...
const LanguageSelector = ({ locale }) => {
	...
	return (
		<div className="relative inline-flex" ref={dropdownRef}>
			<button
				type="button"
				className="flex flex-col lg:flex-row items-center justify-center gap-1 font-title bg-transparent box-border px-3 md:px-3 md:py-2 border border-gray-300 rounded-full md:rounded-md shadow-sm text-sm font-medium text-slate-700 bg-slate-100 md:bg-white hover:bg-gray-50"
			...
			>
				...
				<span className="uppercase leading-6">{locale}</span>
