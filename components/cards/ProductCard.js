...
const ProductCard = ({ product, isFlashSale, isLarge, translations = {} }) => {
  ...
  return (
    <>
      {!loading ? (
        <>
          <div className={` ${stockOut ? "opacity-50" : ""}`}>
            <div
              className={twMerge(
            ...
            >
              <div className="product-img-action-wrap relative">
                ...
                <div className="product-img p-2 pb-0">
                  ...
                  >
                    ...
                    />
                    {stockOut ? (
                      <div className="w-full h-full rounded z-50 absolute left-0 top-0 flex items-center justify-center">
              ...
              <div className="product-content-wrap p-3">
                ...
                <h2 className={`product-title !line-clamp-2 lg:!line-clamp-1 ${stockOut ? "pointer-events-none" : ""}`}>
