      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="col-span-1 relative">
          <div className="banner-img">
            <Image
              src={`/assets/images/banner/ads-lg-banner.jpg`}
              alt="Banner"
              width={0}
              height={0}
              sizes="100vw"
          ...
          <div className="content absolute top-0 left-1/3 w-2/3 h-full flex flex-col justify-center pr-6">
            <p className="text-base font-medium font-title text-white mb-4">
              আপনার শোনার অভিজ্ঞতাকে পরবর্তী স্তরে নিয়ে যাওয়া
            </p>
            <h3 className="text-4xl font-semibold font-title text-white">
              বিট হেডফোন
            </h3>
            <div className="flex items-center gap-3 my-9">
              <h3 className="text-4xl font-bold font-title text-red-500">
                ৳2698
              </h3>
            ...
            <Link
              href={`/`}
              className="inline-block w-max text-base font-semibold font-title text-white bg-primary px-4 py-3 rounded-lg"
            >
        ...
        <div className="col-span-1">
          <div className="grid grid-cols-3 gap-6">
            <div className="col-span-2">
              <div className="grid grid-cols-12 items-center bg-amber-50 rounded-2xl p-6 pb-9">
                ...
                <div className="banner-img col-span-3">
                  <Image
                    src={`/assets/images/shop/phone.png`}
                    alt="Banner"
                    width={80}
                    height={142}
              ...
              <div className="grid grid-cols-2 items-center bg-slate-100 rounded-2xl p-6 mt-6">
                <div className="content col-span-1 flex flex-col justify-between gap-11">
                  ...
                  >
                    বিস্তারিত জানুন <HiArrowLongRight size={24} />
                  </Link>
                </div>
                <div className="banner-img col-span-1">
                  <Image
                    src={`/assets/images/shop/monitor.png`}
                    alt="Banner"
                    width={0}
                    height={0}
                    sizes="100vw"
            ...
            <div className="col-span-1">
              <div className="banner-img">
                <Image
                  src={`/assets/images/banner/ads-banner.jpg`}
                  alt="Banner"
                  width={0}
                  height={0}
                  sizes="100vw"
